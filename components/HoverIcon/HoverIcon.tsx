...
export default function HoverIcon(props: {
    ...
    return (
        <div className="relative w-full h-full max-w-[50px] max-h-[50px] z-[10] cursor-default" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} onClick={clickToggle}>
