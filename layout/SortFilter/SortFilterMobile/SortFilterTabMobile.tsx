...
export default function SortFilterTabMobile(props:{
    ...
    return (
        <div className="w-full h-[50px] flex k:hidden items-center justify-between">
            ...
            <p className="bg-dimm inputheight flex items-center justify-center px-[15px] text-[16px] font-medium textcol-main cursor-pointer" onClick={() => {dispatch(toggleMobileFilterDropdown(true)); dispatch(setMobileFilterSelected("order"))}}>Order By</p>
        </div>
    )
}