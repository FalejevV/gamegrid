...
export default function PlatformFilterDropdown(props:{
    ...
    const sortFilterDropdownSelector = useAppSelector((state : RootState) => state.sortFilter.dropdowns.platform);

    return(
        <div className="w-full h-full flex flex-col gap-[10px] textcol-main pten">
            <OutClickListener target={"platform"} />
            ...
            <div className="flex-auto overflow-y-scroll">
                <SortFilterList searchCriteria={search} itemList={props.itemList} dropdownType={"platform"} />
            </div>
        </div>
    )
}