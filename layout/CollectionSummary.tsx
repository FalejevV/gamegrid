        ...
        return (
            <div className="flex gap-[10px] items-center overflow-x-scroll pb-[10px] visible summary-lg:hidden">
                ...
                <div className="summary-grid-mobile">
                    ...
                    <SummaryStatLong firstLine={lastCompletionDate.getDate()} secondLine={monthNames[lastCompletionDate.getMonth()]} thirdLine={lastCompletionDate.getFullYear()} about={"Last Completion"} firstLineSize="text-[38px]" thirdLineSize="text-[38px]" className="bg-hi saturate-50" />
                    <SummaryStatLong firstLine={popularTags[0]} secondLine={popularTags[1]} thirdLine={popularTags[2]} about={"Popular Tags"} />
        ...
        return (
            <div className="hidden summary-lg:block">
                <section className="summary-grid">
                    ...
                    <SummaryStatLong firstLine={lastCompletionDate.getDate()} secondLine={monthNames[lastCompletionDate.getMonth()]} thirdLine={lastCompletionDate.getFullYear()} about={"Last Completion"} firstLineSize="text-[37px]" thirdLineSize="text-[35px]" className="bg-dimm saturate-[120%]" />
